  ...
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      ...
      <section className="mb-2">
        ...
        <p className="text-white/80 text-lg leading-relaxed">For questions about these Terms, contact us at <a href="mailto:neuralyn.ai@gmail.com" className="text-blue-400 underline">neuralyn.ai@gmail.com</a>.</p>
      </section>
    </motion.div>
  </div>
);
