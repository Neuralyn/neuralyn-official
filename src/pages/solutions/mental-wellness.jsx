...
const MentalWellness = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Empowering minds with AI-driven emotional intelligence, therapy, and support for holistic mental health.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">Neuralyn will deliver personalized, accessible, and stigma-free mental wellness solutions, integrating AI therapy, real-time mood tracking, and global support networks for every individual.</p>
    </motion.div>
  </div>
);
