...
const HealMind = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      AI-powered mental wellness therapy with voice analysis and emotional intelligence. Personalized support for every mind, everywhere.
    </motion.p>
    <motion.div
    ...
    >
      ...
      <p className="text-white/70 text-lg">This is a future product page for HealMind_AI. Here, you will find detailed features, benefits, and how to get started with our AI-powered mental wellness solution.</p>
    </motion.div>
  </div>
);
