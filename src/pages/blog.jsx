...
const Blog = () => (
  <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-20 relative overflow-hidden">
    ...
    >
      Stay updated with the latest in AI healthcare, product news, and company insights from Neuralyn.
    </motion.p>
    <motion.div
    ...
    >
      <h2 className="text-2xl font-semibold mb-4">Our blog will feature insights, news, and updates soon.</h2>
    </motion.div>
  </div>
);
